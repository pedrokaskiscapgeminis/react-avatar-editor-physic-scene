    ...
    <>
      <div className="container mt-4">
        <div className="row">
          <div className="col-10">
            <Canvas shadows camera={{ position: [0, 1.5, 3], fov: 60 }}>
              ...
              <Suspense fallback={null}>
                ...
                <Physics>
                  <Adam position ={[0,-1.3,0]} type ="Static" skin={skin} hair={hair} top={top} bottom={bottom} footwear={footwear} />
                </Physics>
                </Float>
              </Suspense>
          ...
          <button onClick={clickFalse} className="btn btn-primary btn-margin">
            Acept
          </button>
